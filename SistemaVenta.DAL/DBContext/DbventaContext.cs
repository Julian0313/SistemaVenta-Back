...
public partial class DbventaContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdCategoria).HasName("PK__Categori__8A3D240C4DD1B466");
        ...
        {
            entity.HasKey(e => e.IdDetalleVenta).HasName("PK__DetalleV__BFE2843FC0039DA8");
        ...
        {
            entity.HasKey(e => e.IdMenu).HasName("PK__Menu__C26AF483D61A108C");
        ...
        {
            entity.HasKey(e => e.IdMenuRol).HasName("PK__MenuRol__9D6D61A4170F834E");
        ...
        {
            entity.HasKey(e => e.IdNumeroDocumento).HasName("PK__NumeroDo__471E421ACEB19DFF");
        ...
        {
            entity.HasKey(e => e.IdProducto).HasName("PK__Producto__07F4A132AEF05D0B");
        ...
        {
            entity.HasKey(e => e.IdRol).HasName("PK__Rol__3C872F766987D311");
        ...
        {
            entity.HasKey(e => e.IdUsuario).HasName("PK__Usuario__645723A6BC2EEF8B");
        ...
        {
            entity.HasKey(e => e.IdVenta).HasName("PK__Venta__077D5614399B3A50");
